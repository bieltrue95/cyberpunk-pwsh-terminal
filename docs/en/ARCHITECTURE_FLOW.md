...
Language: English | [Português](../ARCHITECTURE_FLOW.md)

Visual and technical documentation of the complete project flow using Excalidraw diagrams.
...
**Diagram Status:** Visual flow documented with Excalidraw
