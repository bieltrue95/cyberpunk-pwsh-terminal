...
foreach ($file in @('setup.ps1','install.ps1','uninstall.ps1','scripts\test-profile.ps1','scripts\merge-windows-terminal.ps1','scripts\configure-branch-protection.ps1','profile\Microsoft.PowerShell_profile.ps1')) {
